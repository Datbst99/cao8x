            ...
            <div class="container row">
                <div class="chili-section-core_content wow fadeInUp" data-wow-delay="0.5s">
                    <div class="uabb-infobox-title-wrap">
                        <h1 class="uabb-infobox-title" style="text-align: center;">CORE VALUES</h1>
                    </div>
                    <div class="uabb-infobox-text-wrap">
                        <div class="uabb-infobox-text uabb-text-editor">
                            <p><strong>Cáo Kidsplay Solutions</strong> is a start-up aiming to create the “learning by playing” platform for infants and toddlers through designing and operating the chain stores of Premium Kidsplay Cafe.</p>
        ...
        <div class="chili-section-business" id="chili-business">
            <div class="container row">
                <div class="chili-section-business_title wow fadeInUp" data-wow-delay="0.5s">
                    <h1 class="uabb-infobox-title-prefix" style="text-align: center;">BUSINESS</h1>
                </div>
                <div class="chili-section-business_conent wow fadeInUp" data-wow-delay="0.5s">
                    <ul>
                        <li>Designing and operating the chain stores of Cáo Premium Kidsplay Cafe – a bistro (restaurant and coffee shop) model intergrated to children playground.</li>
                        <li>Consulting, designing, decorating and organizing birthday parties, family datings, friend meetings and other occasions.</li>
                        <li>Providing catering services for companies and offices.</li>
                        <li>Consulting and providing solutions for setting up amusement parks, kids cafe, inhouse and outdoor playground.</li>
                        <li>In-store advertising and marketing solutions for relevant brands.</li>
                        <li>Consulting, organizing events and branding campaign to promote child-base products and service.</li>
                    </ul>
                </div>
