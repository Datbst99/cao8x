...
@section('plugins-style')
    <link rel="stylesheet" id="wpos-slick-style-css" href="/assets/plugins/slick/slick.css" type="text/css" media="all">
@endsection

@section('content')
    <main id="main">
        <div class="slider">
            <img src="/client/imgs/1.png" alt="thẻ quyền năng">
            <img src="/client/imgs/2.png" alt="thẻ thành viên">
            <img src="/client/imgs/3.png" alt="giá vé">
        </div>
        <div class="chili-section-business" id="chili-business" style="background-image: url('/client/images/cao/4.1.png'); background-repeat: no-repeat; background-size: cover; padding: 30px 8px">
            <div class="container row">
                <div class="chili-section-business_title wow fadeInUp" data-wow-delay="0.5s">
                    <h1 class="uabb-infobox-title-prefix" style="text-align: center; text-transform: uppercase">BIYOKI cùng Ba mẹ tạo nên Em bé hạnh phúc</h1>
                </div>
                <div class="chili-section-business_conent wow fadeInUp" data-wow-delay="0.5s">
                    <ul>
                        <li>Tại BIYOKI các thực phẩm được chọn lọc kĩ lưỡng , nguyên liệu sạch giúp ba mẹ an tâm.</li>
                        <li>Tại BIYOKI có các buổi chia sẻ kinh nghiệm để ba mẹ có thêm kiến thức để chăm sóc và nuôi dạy con trẻ.</li>
                        <li>Tại BIYOKI có các bạn nhân viên sẵn sàng làm bạn cùng các con, lắng nghe các con tâm sự.</li>
                        <li>Tại BIYOKI có không gian-các con là chủ đạo trong kích thước đồ chơi và giao tiếp.</li>
                        <li>Tại BIYOKI có các trò chơi phù hợp lứa tuổi để các con được tham gia theo khu vực , thông qua các trò chơi các con sẽ được phát triển các kĩ năng vận động và nhận thức xã hội.</li>
                        <li>BIYOKI Family & Kids Coffee là nơi chia sẻ và đồng hành cùng các ba mẹ chuẩn bị có con, đang mang bầu và đã sinh con.</li>
                    </ul>
                </div>
                {{--                <div class="chili-section-business_gallery">--}}
                {{--                    <div class="row row-small row-full-width align-equal align-center chili-nav-slider-special" id="row-948429488">--}}
                {{--                        <div id="col-1273827292" class="col medium-4 small-12 large-4">--}}
                {{--                            <div class="col-inner">--}}
                ...
                {{--                            </div>--}}
                {{--                        </div>--}}
                {{--                        <div id="col-1509298745" class="col medium-4 small-12 large-4">--}}
                {{--                            <div class="col-inner">--}}
                ...
                {{--                            </div>--}}
                {{--                        </div>--}}
                {{--                        <div id="col-1560437705" class="col medium-4 small-12 large-4">--}}
                {{--                            <div class="col-inner">--}}
        ...
        <div class="chili-section-core" id="chili-core">
{{--            <div class="container row">--}}
{{--                <div class="chili-section-core_content wow fadeInUp" data-wow-delay="0.5s">--}}
{{--                    <div class="uabb-infobox-title-wrap">--}}
{{--                        <h1 class="uabb-infobox-title" style="text-align: center; text-transform: uppercase">BIYOKI cùng Ba mẹ tạo nên Em bé hạnh phúc</h1>--}}
{{--                    </div>--}}
{{--                    <div class="uabb-infobox-text-wrap">--}}
{{--                        <div class="uabb-infobox-text uabb-text-editor">--}}
{{--                            <p><strong>BIYOKI Family & Kids Coffee</strong> is a start-up aiming to create the “learning by playing” platform for infants and toddlers through designing and operating the chain stores of Premium Kidsplay Cafe.</p>--}}
{{--                            <p>Our aspiration is to promote family engagement by providing parents with comfortable food and beverage service, while edutaining their infants and toddlers with designated playing area.</p>--}}
{{--                            <p>Along with F&B and Edutainment activities, we also develop our stores as a Marketing & Advertising channel for Mom & Baby brands.</p>--}}
{{--                        </div>--}}
{{--                    </div>--}}
{{--                </div>--}}
{{--                <div class="chili-section-core_image">--}}
{{--                    <img src="/client/images/caokids-1.png" width="100%" height="100%">--}}
{{--                </div>--}}
{{--            </div>--}}
{{--            <div class="chili-section-core_banner"><img src="/client/images/cao/4.1.png" width="100%" height="100%"></div>--}}
        </div>
        <div class="chili-section-development chili-bg" id="chili-development">
            <div>
{{--                <div class="container row">--}}
{{--                    <div class="chili-section-development_title">--}}
{{--                        <h1 class="uabb-infobox-title" style="text-align: center;">DEVELOPMENT TIMELINE</h1>--}}
{{--                    </div>--}}
{{--                </div>--}}
                <div class="chili-section-development_banner">
                    <img class="chili-section-development_banner_pc" src="/client/images/cao/1.1.png" width="100%" height="100%">
{{--                    <div class="chili-section-development_timeline">--}}
{{--                        <div class="chili-section-development_timeline__left-one">--}}
{{--                            <div class="chili-section-development_timeline__left-one-title wow fadeInUp" data-wow-delay="0.5s">--}}
{{--                                2020--}}
{{--                            </div>--}}
{{--                            <div class="chili-section-development_timeline__left-one-content wow fadeInUp" data-wow-delay="0.5s">--}}
{{--                                <p>Established first store at District 10, HCMC, introducing the integrated service for parents and kids.</p>--}}
{{--                            </div>--}}
{{--                        </div>--}}
{{--                        <div class="chili-section-development_timeline__right-one">--}}
{{--                            <div class="chili-section-development_timeline__right-one-title wow fadeInUp" data-wow-delay="0.5s">--}}
{{--                                2021                    </div>--}}
{{--                            <div class="chili-section-development_timeline__right-one-content wow fadeInUp" data-wow-delay="0.5s">--}}
{{--                                <p>Setting up chain stores , expanding locations and service for young families and kids.</p>--}}
{{--                            </div>--}}
{{--                        </div>--}}
{{--                        <div class="chili-section-development_timeline__left-two">--}}
{{--                            <div class="chili-section-development_timeline__left-two-title wow fadeInUp" data-wow-delay="0.5s">--}}
{{--                                2022                    </div>--}}
{{--                            <div class="chili-section-development_timeline__left-two-content wow fadeInUp" data-wow-delay="0.5s">--}}
{{--                                <p><em>To be updated …</em></p>--}}
{{--                            </div>--}}
{{--                        </div>--}}
{{--                        <div class="chili-section-development_timeline__right-two">--}}
{{--                            <div class="chili-section-development_timeline__right-two-title wow fadeInUp" data-wow-delay="0.5s">--}}
{{--                                2023                    </div>--}}
{{--                            <div class="chili-section-development_timeline__right-two-content wow fadeInUp" data-wow-delay="0.5s">--}}
{{--                                <p><em>To be updated …</em></p>--}}
{{--                            </div>--}}
{{--                        </div>--}}
{{--                        <div class="chili-section-development_timeline__left-three">--}}
{{--                            <div class="chili-section-development_timeline__left-three-title wow fadeInUp" data-wow-delay="0.5s">--}}
{{--                                2024                    </div>--}}
{{--                            <div class="chili-section-development_timeline__left-three-content wow fadeInUp" data-wow-delay="0.5s">--}}
{{--                                <p><em>To be updated …</em></p>--}}
{{--                            </div>--}}
{{--                        </div>--}}
{{--                    </div>--}}
                    <img class="chili-section-development_banner_mobile" src="/client/images/cao/1.1.png" width="100%" height="100%">
                </div>
            </div>
        </div>
