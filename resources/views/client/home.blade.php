...
@section('content')
    <main id="main">
        ...
        <div class="chili-section-core" id="chili-core">
            ...
            <div class="chili-section-core_banner"><img src="/client/images/t2.jpg" width="100%" height="100%"></div>
        </div>
        <div class="chili-section-development chili-bg" id="chili-development">
            <div>
                ...
                <div class="chili-section-development_banner">
                    <img class="chili-section-development_banner_pc" src="/client/images/bg-development-timeline-c.jpg" width="100%" height="100%">
                    ...
                    <img class="chili-section-development_banner_mobile" src="/client/images/bg-development-timeline-mobile-final.jpg" width="100%" height="100%">
                </div>
            </div>
        </div>
        <div class="chili-section-business" id="chili-business">
            <div class="container row">
